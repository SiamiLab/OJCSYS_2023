...
class SpeedController:
    ...
    def update(self, theta1, theta2, theta3, dt, t):     
        ...
        if t<time_shift:
            ...
            error13 = -(theta3 - theta1 - 2*2*(np.pi/3))
            error_net_new = error12 + error13
...
class SpeedController3:
    ...
    def update(self, theta1, theta2, theta3, dt, t):
        ...
        if t<time_shift: 
            ...
            #Formation Error
            error31 =  (theta3 - theta1 - 2*2*(np.pi/3))
            error32 =  (theta3 - theta2 - 1*2*(np.pi/3))
            error_net_3 = error32 + error31
...
def controlLoop():
    ...
    while t<(tf + startDelay) and (not KILL_THREAD):
        ...
        if time_counter < startDelay:
            ...
            speed1 = speedController.update(theta1, theta2, theta3, dt, t)
            bb = speed1[0]
            ...
            speed3 = speedController3.update(theta1, theta2, theta3, dt, t)
            bb3 = speed3[0]
